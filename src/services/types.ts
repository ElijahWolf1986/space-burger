...
export const SHOW_ERROR_POPUP: "SHOW_ERROR_POPUP" = "SHOW_ERROR_POPUP";
export const HIDE_ERROR_POPUP: "HIDE_ERROR_POPUP" = "HIDE_ERROR_POPUP";
...
export const REM_ORDER: "REM_ORDER" = "REM_ORDER";
export const GET_SELECTED_ORDER: "GET_SELECTED_ORDER" = "GET_SELECTED_ORDER";
export const REM_SELECTED_ORDER: "REM_SELECTED_ORDER" = "REM_SELECTED_ORDER";

//actions для работы модального окна меню
export const SHOW_MENU: "SHOW_MENU" = "SHOW_MENU";
export const HIDE_MENU: "HIDE_MENU" = "HIDE_MENU";
export const SHOW_PERSONAL_MENU: "SHOW_PERSONAL_MENU" = "SHOW_PERSONAL_MENU";
export const HIDE_PERSONAL_MENU: "HIDE_PERSONAL_MENU" = "HIDE_PERSONAL_MENU";
...
export const REM_USER_INFO: "REM_USER_INFO" = "REM_USER_INFO";
